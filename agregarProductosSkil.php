...
echo $_SESSION['NombreUsuario'];?></a> <!--Traer nombre de la persona que inicia sesion-->
        </div>
      </div>
...
?>
                      <tr>
                        <form action="agregarProductosSkilBack.php" method="post" enctype="multipart/form-data">
                       ...
                       <td><input type="number" name="cantidadProducto" id="" placeholder="Cantidad" required></td>
                      <td><input type="text" name="codigoi" id="" placeholder="Código 1" required></td>
                      <td><input type="text" name="codigoii" id="" placeholder="Código 2" required></td>
                      <td>
                      <select name="segmento">
                      <?php
require 'conexion.php';
$Query = "SELECT distinct(segmento) as sg FROM skil";
$Result = mysqli_query($conexion, $Query);
while ($row = $Result->fetch_assoc()) {
    ?>
                      ...
                      <td><input type="text" name="material" id="" placeholder="Material" required>
                    </td>
                      <td><input type="text" name="descripcion" id="" placeholder="Descripción" required></td>
                      <td>
                      <select name="presentacion">
                      <?php
require 'conexion.php';
$Query = "SELECT distinct(presentacion) as ps FROM skil";
$Result = mysqli_query($conexion, $Query);
while ($row = $Result->fetch_assoc()) {
    ?>
                      ...
                      <td>
                        <select name="fuente">
                            <?php
require 'conexion.php';
$Query = "SELECT distinct(fuente) as fn FROM skil";
$Result = mysqli_query($conexion, $Query);
while ($row = $Result->fetch_assoc()) {
    ?>
