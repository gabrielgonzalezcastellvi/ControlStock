          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    $id = $_GET['id'];
                    require 'conexion.php';       
                    $Query = "SELECT * FROM dremel WHERE id = '$id'";
                    $Result = mysqli_query($conexion,$Query);
                    ...
                    while($row2=$Result->fetch_assoc()){
                      ...
                      <td><a href ="editardremel.php?id=<?php echo $row2['id'];?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                      <td><a href="borrarProductoDremel.php?id=<?php echo $row2['id'];?>"><i class="fa-solid fa-trash"></i></td>
              ...
              <div class="card-footer clearfix">
                <a href="dremelAll.php" class="btn btn-sm btn-secondary float-right">Ver todos los Productos</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
