                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tr>
                     ...
                     if(empty($Buscar)){
                      $query2 = "SELECT id,cantidad,codigoii,segmento,material,thumb FROM skil";
                     }else{
                      $query2 = "SELECT id,cantidad,codigoii,segmento,material,thumb FROM skil WHERE codigoii LIKE '%$Buscar%'";
                     }
                      ...
                      <td><a href="masdetallesskil.php?id=<?php echo $row2['id'];?>">Más detalles</a></td>
                     </tr>
                    <?php 
                      }
                      ?>
