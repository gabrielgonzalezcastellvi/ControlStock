          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    $id = $_GET['id'];
                    require 'conexion.php';       
                    $Query = "SELECT * FROM skil WHERE id = '$id'";
                    $Result = mysqli_query($conexion,$Query);
                    ...
                    while($row2=$Result->fetch_assoc()){
                      ...
                      <td><?php echo '$'.$row2['preciolista']; ?></td>
                      <td><?php echo '$'.$row2['pvpsugerido']; ?></td>
                      <td><?php echo '$'.$row2['pvppremium']; ?></td>
                      <td><a href ="editarskil.php?id=<?php echo $row2['id'];?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                      <td><a href="borrarProductoSkil.php?id=<?php echo $row2['id'];?>"><i class="fa-solid fa-trash"></i></td>
              ...
              <div class="card-footer clearfix">
                <a href="skilAll.php" class="btn btn-sm btn-secondary float-right">Ver todos los Productos</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->
