...
$QueryVentas = "SELECT * FROM ventasskil WHERE numventa = '$NumVenta'";
...
while($row0 = $resultado->fetch_assoc()){
    ...
    $QueryStockActual = "SELECT cantidad FROM skil WHERE codigoii = '$Codigo2'";
    ...
    $QueryActualizacion = "UPDATE skil SET cantidad = '$NuevoStock' WHERE codigoii = '$Codigo2'";
    
    
    $ResultActualizacion = mysqli_query($conexion,$QueryActualizacion);
}

$B = $ResultActualizacion ? header("Location: ./ventasSkil.php") : 'No se pudo actualizar el stock'; 
