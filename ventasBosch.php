  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Ventas | Bosch</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="bosh.php">Inicio</a></li>
...
<div class="card">
              <div class="card-header border-transparent">
                ...
                <br>
                <br>
                <form action="ventasBosch.php" method="post">
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                        <?php 
                        require 'conexion.php';
                        $Query2 = "SELECT MAX(numventa)  AS NV FROM ventasfinalesbosch";  //Selecciono el numero más alto de l
                        ...
                        ?>
                      <tr>
                        <form action="ventasBoschback.php" method="post">
                            <input type="hidden" name="numventa" value="<?php echo $NumeroDeVenta; ?>">
                            <?php 
                            require 'conexion.php';
                            $Query = "SELECT * FROM bosh WHERE codigoii LIKE '$Codigo2'";
                      ...
                      <td><input type="text" name="descripcion" id="" value="<?php echo $row3['descripcion']; ?>" required></td>
                      <td>
                      <select name="presentacion">
                      <option value="<?php echo $row3['presentacion'];?>" required><?php echo $row3['presentacion'];?></option>
                      </td>
                      <td><input type="text" name="linea" id="" value="<?php echo $row3['linea'];?>" required></td>
                      <td>
                        <select name="fuente">
                        <option value="<?php echo  $row3['fuente'];?>"><?php echo $row3['fuente']; ?></option>
                        </select>
                      </td>
                      <td><input type="text" name="ean" id="" value="<?php echo $row3['ean']; ?>"></td>
                      <td><input type="text" name="iva" id="" value="<?php echo $Iva; ?>"></td>
                      <td><input type="text" name="precioLista" id="" placeholder="Precio Lista" required></td>
                      <td><input type="text" name="margendescuento" id=""></td>
                      <td><input type="text" name="descuento" id=""></td>
                      ...
                      <td><a href="./ventasBosch.php"><input type="button" value="Cancelar" class="btn btn-danger" title="Cancelar"></a></td>
                      </form>
                    </tr>
                    </tbody>
                  </table>
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                        ...
                        <form action="ventasFinalesBosch.php" method="post">
                        <?php 
                        require 'conexion.php';
                        $QueryNumVenta = "SELECT MAX(numventa) AS NV FROM ventasfinalesbosch";
                        $ResultNumVenta = mysqli_query($conexion,$QueryNumVenta);
                        while($row1 = $ResultNumVenta -> fetch_assoc()){
                          $NumVenta = $row1['NV'] + 1;
                        }
                      
                        $Query = "SELECT * FROM ventasbosch WHERE numventa = '$NumVenta' AND linea <> '0'";
                        $Result = mysqli_query($conexion,$Query);
                        while($row = $Result ->fetch_assoc()){
                        ?>
                     <tr>
                      <td><input type="number" name="cantidad" id="" value="<?php echo $row['cantidad'];?>"></td>
                      <td><input type="text" name="codigoii" id="" value="<?php echo $row['codigoii'];?>" readonly></td>
                      <td><input type="text" name="segmento" id="" value="<?php echo $row['segmento'];?>" readonly></td>
                      <td><input type="text" name="material" id="" value="<?php echo $row['material'];?>" readonly></td>
                      <td><input type="text" name="descripcion" id="" value="<?php echo $row['descripcion'];?>" readonly></td>
                      <td><input type="text" name="presentacion" id="" value="<?php echo $row['presentacion'];?>" readonly></td>
                      <td><input type="text" name="linea" id="" value="<?php echo $row['linea'];?>" readonly></td>
                      <td><input type="text" name="fuente" id="" value="<?php echo $row['fuente'];?>" readonly></td>
                      <td><input type="text" name="ean" id="" value="<?php echo $row['ean'];?>" readonly></td>
                      <td><input type="text" name="iva" id="" value="<?php echo $row['iva'];?>" readonly></td>
                      <td><input type="text" name="precioLista" id="" value="<?php echo $row['precioLista'];?>" readonly></td>
                      <td><input type="text" name="pvpsugerido" id="" value="<?php echo $row['pvpsugerido'];?>" readonly></td>
                      <td><input type="text" name="pvppremium" id="" value="<?php echo $row['pvppremium'];?>" readonly></td>
                      <input type="hidden" name="numventa" value="<?php echo $NumVenta; ?>">
                      <td><a href="./quitarProductoBosch.php?id=<?php echo $row['id']; ?>"><input type="button" value="Quitar" class="btn btn-danger" title="Quitar"></a></td>
                      <?php } ?>  
