...
$Query = "INSERT INTO `bosh`(`id`, `codigoi`, `codigoii`, `segmento`, `material`, `descripcion`, `presentacion`, `linea`, `fuente`, `ean`, `iva`, `preciosiniva`, `pvpiva`, `pvppremium`, `cantidad`, `thumb`) VALUES ('DEFAULT','$Codigoi','$Codigoii','$Segmento','$Material','$Descripcion','$Presentacion','$Linea','$Fuente','$Ean','$Iva','$PrecioLista','$PvpSugerido','$PvpPremium','$CantidadProducto','$nombre')";

$Result = mysqli_query($conexion, $Query);

$A = $Result ? header("Location: ./bosh.php") : 'No sé pudo agregar el producto correctamente';
