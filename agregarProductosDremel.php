                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                        ...
                        ?>
                      <tr>
                      <form action="agregarProductosDremelBack.php" method="post" enctype="multipart/form-data">
                      ...
                      <?php
                      require 'conexion.php';
                      $Query = "SELECT distinct(familia) as fm FROM dremel";
                      $Result = mysqli_query($conexion,$Query);
                      while($row = $Result->fetch_assoc()){
                      ?>
                        <option value="<?php echo $row['fm'];?>" required><?php echo $row['fm'];?></option>
                        <?php } ?>
                      </select>
                      </td>
                      <td>
                        <select name="subfamilia">
                            <?php
                        require 'conexion.php';
                      $Query = "SELECT distinct(subfamilia) as sf FROM dremel";
                      $Result = mysqli_query($conexion,$Query);
                      while($row = $Result->fetch_assoc()){
                        ?>
                        <option value="<?php echo  $row['sf'];?>"><?php echo $row['sf']; ?></option>
                        <?php }
                        ?>
                        </select>
                      </td>
                      ...
                      <td><a href="./dremel.php"><input type="button" value="Cancelar" class="btn btn-danger" title="Cancelar"></a></td>
                      </form>
                    </tr>
                    </tbody>
                  </table>
