    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form action="masdetallesbosh.php" method="POST" class="form-inline">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Control Stock | Bosh</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <a href="ventasBosch.php"><i class="fas fa-shopping-cart"></i></a></span>
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header border-transparent">
                <h3 class="card-title">Productos Bosh</h3>
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    $id = $_GET['id'];
                    require 'conexion.php';       
                    $Query = "SELECT * FROM bosh WHERE id = '$id'";
                    $Result = mysqli_query($conexion,$Query);
                    ...
                    while($row2=$Result->fetch_assoc()){
                      ...
                      <td><?php echo $row2['fuente']; ?></td>
                      <td><?php echo $row2['ean']; ?></td>
                      <td><?php echo $row2['iva']; ?></td>
                      <td><?php echo '$'.$row2['preciosiniva']; ?></td>
                      <td><?php echo '$'.$row2['pvpiva']; ?></td>
                      <td><?php echo '$'.$row2['pvppremium']; ?></td>
                      <td><?php echo '$'.$row2['descuento45']; ?></td>
                      <td><?php echo '$'.$row2['margen25']; ?></td>
                      <td><?php echo '$'.$row2['margen28']; ?></td>
                      <td><?php echo '$'.$row2['margen30']; ?></td>
                      <td><?php echo '$'.$row2['margen35']; ?></td>
                      <td><?php echo '$'.$row2['margen45']; ?></td>
                      <td><a href ="editarbosch.php?id=<?php echo $row2['id'];?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                      <td><a href="borrarProductoBosch.php?id=<?php echo $row2['id'];?>"><i class="fa-solid fa-trash"></i></td>
