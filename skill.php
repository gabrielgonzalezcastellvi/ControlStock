                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                      ...
                      <?php 
                      require 'conexion.php';
                      $Query = "SELECT id,cantidad,codigoi,codigoii,segmento,material,thumb FROM skil LIMIT 15";
                      $Result = mysqli_query($conexion,$Query);
                      while($row = $Result->fetch_assoc()){
                      ?>
                      ...
                      <td><?php echo $row['codigoii']; ?></td>
                      <td><?php echo $row['segmento']; ?></td>
                      <td><?php echo $row['material']; ?></td>
                      <td><a href="masdetallesskil.php?id=<?php echo $row['id'];?>">Más detalles</a></td>
                    </tr>
                    <?php
                      }
                      ?>
