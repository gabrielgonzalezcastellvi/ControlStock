  ...
  <nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="dremel.php" class="nav-link">Inicio</a>
      </li>
    </ul>
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              <span class="info-box-icon bg-success elevation-1"><a href="ventasDremel.php"><i class="fas fa-shopping-cart"></a></i></span>
...
<div class="card">
              <div class="card-header border-transparent">
                ...
                <br>
                <br>
                <form action="ventasDremel.php" method="post">
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                        <?php 
                        require 'conexion.php';
                        $Query2 = "SELECT MAX(numventa)  AS NV FROM ventasfinalesdremel";  //Selecciono el numero más alto de l
                        $ResultNumeroDeVenta = mysqli_query($conexion,$Query2);
                        while($row3 = $ResultNumeroDeVenta -> fetch_assoc()){
                            $NumeroDeVenta = $row3['NV'] + 1;
                        }
                        $Query = "SELECT *,iva, MAX(id) as id FROM dremel";
                        $Result = mysqli_query($conexion,$Query);
                        while($row = $Result ->fetch_assoc()){
                         $Id = $row['id'] + 1;
                         $Iva = $row['iva'];
                        ...
                        ?>
                      <tr>
                        <form action="ventasDremelback.php" method="post">
                            <input type="hidden" name="numventa" value="<?php echo $NumeroDeVenta; ?>">
                            <?php 
                            require 'conexion.php';
                            $Query = "SELECT * FROM dremel WHERE codigoii LIKE '$Codigo2'";
                      ...
                      <td>
                      <select name="familia">
                        <option value="<?php echo $row3['familia'];?>" required><?php echo $row3['familia'];?></option>
                      </select>
                      </td>
                      <td><input type="text" name="subfamilia" value="<?php echo $row3['subfamilia'];?>"  required>
                    </td>
                      ...
                      <td><a href="./ventasDremel.php"><input type="button" value="Cancelar" class="btn btn-danger" title="Cancelar"></a></td>
                      </form>
                    </tr>
                    </tbody>
                  </table>
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tbody>
                        ...
                        <form action="ventasFinalesDremel.php" method="post">
                        <?php 
                        require 'conexion.php';
                        $QueryNumVenta = "SELECT MAX(numventa) AS NV FROM ventasfinalesdremel";
                        $ResultNumVenta = mysqli_query($conexion,$QueryNumVenta);
                        while($row1 = $ResultNumVenta -> fetch_assoc()){
                         $NumVenta = $row1['NV'] + 1;
                        }
                      
                        $Query = "SELECT * FROM ventasdremel WHERE numventa = '$NumVenta' AND familia <> '0'";
                        $Result = mysqli_query($conexion,$Query);
                        while($row = $Result ->fetch_assoc()){
                        ?>
                     <tr>
                      ...
                      <td><input type="text" name="familia" id="" value="<?php echo $row['familia'];?>" readonly></td>
                      <td><input type="text" name="subfamilia" id="" value="<?php echo $row['subfamilia'];?>" readonly></td>
                      ...
                      <td><a href="./quitarProductoDremel.php?id=<?php echo $row['id']; ?>"><input type="button" value="Quitar" class="btn btn-danger" title="Quitar"></a></td>
                      <?php } ?>  
