    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" action = "boshAll.php" method="POST">
                ...
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tr>
                     ...
                     if(empty($Buscar)){
                      $query2 = "SELECT id,cantidad,codigoii,segmento,material,thumb FROM bosh";
                     }else{
                      $query2 = "SELECT id,cantidad,codigoii,segmento,material,thumb FROM bosh WHERE codigoii LIKE '%$Buscar%'";
                     }
